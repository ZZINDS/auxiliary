...
class CommAdminView(BaseAdminView):
    ...
    def get_nav_menu(self):
        ...
        for model, model_admin in self.admin_site._registry.items():
            ...
            model_dict = {
                ...
                'model_ordering': self.get_model_ordering(model),
            }
        ...
        site_menu = sorted(site_menu, key=lambda x: x['menus'][0]['model_ordering'])
        return site_menu
    ...
    def get_model_ordering(self, model):
        model_ordering = getattr(self.admin_site._registry[model],
                                 'model_ordering', 999)
